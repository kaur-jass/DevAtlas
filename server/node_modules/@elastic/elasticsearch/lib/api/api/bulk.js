...
async function BulkApi(params, options) {
    var _a, _b;
    const operations = (_a = params.operations) !== null && _a !== void 0 ? _a : params.body;
    if (operations == null) {
        throw new transport_1.errors.ConfigurationError('Missing required parameter [operations]');
    }
